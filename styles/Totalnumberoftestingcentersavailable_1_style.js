...
var style_Totalnumberoftestingcentersavailable_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Hospitals");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 1.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.000000 && value <= 11.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.800000 && value <= 32.000000) {
            style = [ new ol.style.Style({
